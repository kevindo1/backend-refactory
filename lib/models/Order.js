...
module.exports = class Order {
  ...
  static async insert({ product, quantity }) {
    ...
    // create new instance of Order class which will create a new row
    // when call new, it calls the constructor
    // id of new object is whatever id of the row passed in as
